...
import com.acxdev.commonFunction.util.IDataType.add0
import com.acxdev.commonFunction.util.IDataType.isEmailValid
import com.acxdev.commonFunction.util.IDataType.toDate
import com.acxdev.commonFunction.util.IFunction.getCompatActivity
...
object ITextInputLayout {
    ...
    fun TextInputLayout.timePicker(title: String, timeFormat: Int? = null) {
        ...
        picker.addOnPositiveButtonClickListener {
            editText!!.setText(
                "${picker.hour.toString().add0()}:${
                    picker.minute.toString().add0()
                }"
            )
        }
    }
