...
object Toast {
    fun Context.toasty(toast: Toast, string: String) {
        when (toast) {
            ...
            Toast.SUCCESS -> Toasty.success(this, string, android.widget.Toast.LENGTH_LONG, true)
                .show()
            Toast.WARNING -> Toasty.warning(this, string, android.widget.Toast.LENGTH_LONG, true)
                .show()
    ...
    fun Fragment.toasty(toast: Toast, string: String) {
        when (toast) {
            Toast.INFO -> Toasty.info(context!!, string, android.widget.Toast.LENGTH_LONG, true)
                .show()
            Toast.SUCCESS -> Toasty.success(
                context!!,
                string,
            ...
            Toast.ERROR -> Toasty.error(context!!, string, android.widget.Toast.LENGTH_LONG, true)
                .show()
        }
    }
